...
{	
    ...
    {
        echo "Each Bibcite shortcode retrieves references from a specified online <a href='http://www.bibtex.org/Format/'>Bibtex</a> file. If a given shortcode does not contain a <tt>file=...</tt> attribute defining the URI, it will use a default Bibtex file instead.";
    }
    ...
    {
        echo "When using the <tt>[bibshow]...[/bibshow]</tt> and <tt>[bibcite]</tt> shortcodes, Bibcite creates a note for each <tt>[bibcite key=...]</tt> entry and a bibiliography at the closing <tt>[/bibshow]</tt> shortcode. These settings control the appearance of those notes and bibliography.";
    }
    ...
    {
        echo "When using the <tt>[bibtex key=...]</tt> shortcode, Bibcite creates a standalone bibliography containing the specified references.These settings control the appearance of that bibliography.";
    }
    ...
    public function do_library_url_chooser()
    {
        ...
        echo "<p class='description'>URL at which the default Bibtex library file can be found. To override this setting, specify a <tt>file=...</tt> attribute on your shortcodes.</p>";
    }
    ...
    public function do_bibshow_style_chooser()
    {
        ...
        echo "<p class='description' title='Citation style language'>Default <a href='http://citationstyles.org/'>CSL</a> style for bibliography entries. To override this setting, add a <tt>style=...</tt> attribute to your opening <tt>[bibshow]</tt> shortcode.</p>";
    }
    ...
    public function do_bibshow_template_chooser()
    {
        ...
        echo "<p class='description'>Default <a href='https://twig.symfony.com/'>Twig</a> template for the list of bibliography entries. To override this setting, add a <tt>template=...</tt> attribute to your opening <tt>[bibshow]</tt> shortcode.</p>";
    }
    ...
    public function do_bibcite_style_chooser()
    {
        ...
        $setting = esc_attr(get_option($id));
        echo "<input list='csl-style-names' name='$id' id='$id' value='$setting'/>";
        echo "<p class='description' title='Citation style language'>Default <a href='http://citationstyles.org/'>CSL</a> style for individual citations. To override this setting, add a <tt>style=...</tt> attribute to your <tt>[bibcite]</tt> shortcodes.</p>";
    }
    ...
    public function do_bibcite_template_chooser()
    {
        ...
        $setting = esc_attr(get_option($id));        
        echo "<input list='twig-template-names' name='$id' id='$id' value='$setting'/>";
        echo "<p class='description'>Default <a href='https://twig.symfony.com/'>Twig</a> template for rendering a single <tt>[bibcite]</tt> citation. To override this setting, add a <tt>template=...</tt> attribute to your <tt>[bibcite]</tt> shortcodes.</p>";
    }
    ...
    public function do_bibtex_style_chooser()
    {
        ...
        $setting = esc_attr(get_option($id));        
        echo "<input list='csl-style-names' name='$id' id='$id' value='$setting'/>";
        echo "<p class='description' title='Citation style language'>Default <a href='http://citationstyles.org/'>CSL</a> style for bibliography entries. To override this setting, add a <tt>style=...</tt> attribute to your <tt>[bibtex]</tt> shortcode.</p>";
    }
    ...
    public function do_bibtex_template_chooser()
    {
        ...
        echo "<p class='description'>Default <a href='https://twig.symfony.com/'>Twig</a> template for the list of bibliography entries. To override this setting, add a <tt>template=...</tt> attribute to your <tt>[bibtex]</tt> shortcode.</p>";
    }
